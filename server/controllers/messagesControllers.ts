...
export class MessagesController {
    ...
    createChatroom = async (req: Request, res: Response) => {
		...
		try {
			...
			const result = await this.messagesService.createChatroom(nameList, ownerId, chatroomName, isGroup)
    ...
    getChatroomList = async (req: Request, res: Response) => {
		...
		try {
            ...
            const result = await this.messagesService.getChatroomList(parseInt(userId))
	...
	getMessages = async (req: Request, res: Response) => {
		...
		try {
            ...
            const result = await this.messagesService.getMessages(parseInt(chatroomId))
	...
	sendMessage = async (req: Request, res: Response) => {
		...
		try {
            ...
            const message = await this.messagesService.sendMessage(userId, chatroomId, text)
