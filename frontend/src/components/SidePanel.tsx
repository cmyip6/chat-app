...
export default function SidePanel() {
    ...
    // Side Panel resize
    const mouseDownHandler = (mouseDownEvent: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return (
        <div style={{ width: `${size}px`, boxShadow: '1px 0px 0px #E6E6E6', position: 'relative', visibility: `${size <= 50 ? 'hidden' : 'visible'}` }} className='d-flex flex-column'>
            <Button
                size='xs'
                variant='subtle'
