import { Box, Center, ColorScheme, ColorSwatch, Container, Group, SegmentedControl, Title, useMantineColorScheme, useMantineTheme } from '@mantine/core'
    ...
    return (
        <Container className='col-6 d-flex flex-column text-center'>
            ...
            <Group position="center" my='md'>
                <SegmentedControl
                    value={colorScheme}
                    onChange={(value: 'light' | 'dark') => handleToggleColorScheme(value)}
                    data={[
                        {
                            value: 'light',
                            label: (
