...
export default function NewMemberModal(props: { isShow: boolean, onClose: () => void, chatroomId: number }) {
    ...
    return (
        <Modal 
            ...
            <Input.Wrapper label='Select Users' required style={{ marginBottom: '10px' }}>
            ...
            {value.length > 0 && <Button variant='light' fullWidth onClick={onClick}>Add</Button>}
        </Modal>
    )
}
